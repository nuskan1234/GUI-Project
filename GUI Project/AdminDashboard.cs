...
namespace GUI_Project
{
    public partial class AdminDashboard : Form
    {
        ...
        private void lbl_lec_Click(object sender, EventArgs e)
        {

        }

        private void btn_min_Resize(object sender, EventArgs e)
        {
